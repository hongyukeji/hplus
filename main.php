 ...
 * 堂堂正正做人，踏踏实实做事。
 * ----------------------------------------------------------------------------
 * Author: Shadow  QQ: 1527200768  Time: 2017/7/11 23:26
...
<div id="wrapper">
    ...
    <div id="page-wrapper" class="gray-bg dashbard-1">
        ...
        <div class="row J_mainContent" id="content-main">
            <!--默认首页-->
            <iframe class="J_iframe" name="iframe0" width="100%" height="100%" src="home.php" frameborder="0" data-id="home.php" seamless></iframe>
        </div>
        <div class="footer">
            <div class="pull-right">&copy; 2014-2015 <a href="http://www.hongyuvip.com/" target="_blank">HongYu</a>
            </div>
        </div>
    </div>
    <!--右侧部分结束-->
